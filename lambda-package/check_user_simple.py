#!/usr/bin/env python3
"""
Script simple pour vérifier le username associé à un email
"""
import os
import psycopg2
...
if not DATABASE_URL:
    print("❌ DATABASE_URL non défini dans l'environnement")
    print("💡 Définissez DATABASE_URL avant d'exécuter ce script")
    sys.exit(1)
